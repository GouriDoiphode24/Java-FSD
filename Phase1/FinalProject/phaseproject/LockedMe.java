package com.simplilearn.phaseproject;
...
public class LockedMe {
	...
	public static String[] getFiles(String location)
	{
		...
		//Replaced with sorting algorithm
		Arrays.sort(files);
	...
	public static Boolean addFile(String location) throws IOException
	{
		...
		System.out.println("Enter the message you want to enter in file: ");
	...
	public static void main(String[] args) {
		Scanner sc = new Scanner(System.in);
		System.out.println("------------------------------------------------------------");
		System.out.println("Welcome to LockedMe.com...This application is Developed by Gouri Doiphode");
		System.out.println("------------------------------------------------------------");
		while(true)
		{
			System.out.println("Select any option from the following to continue: ");
